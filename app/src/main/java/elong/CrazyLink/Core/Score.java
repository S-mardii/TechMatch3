...
public class Score {
	int mTotalScore = 0;	//总成绩 Overall result
	int mAwardScore = 0;	//当次的奖励 When the reward
	float mAwardRatio = 0;	//奖励倍数
	int mContinueCnt = 0;	//连续消除次数 Continuous elimination times
	
	int mOver3 = 0;			//超过3个 More than three
	int mJust3 = 0;			//等于3个 Equal to three
	...
	//奖励规则，可以自己调整 Score get after a match
	...
	//本次奖励的分数 The score of this award
	...
	//获取累计分数 Get the cumulative score
	public int getScore()
	{
		return mTotalScore;
	}
	...
	//获取连续消除的次数 Get the number of consecutive erasure
