...
public class ControlCenter {
	...
	public void initTexture(GL10 gl)
	{
    	...
    	animalTextureId = initTexture(gl, R.drawable.tech);	//初始化纹理对象
    	for(int i = 0; i < 10; i++)
    	{
...
//    	gridTextureId = initTexture(gl, R.drawable.grid);
    	...
    	monsterTextureId = initTexture(gl, R.drawable.tech	);
	...
	public void drawGameScene(GL10 gl)
	{
		...
		drawLife.draw(gl, mScore.mLife); //Gamescore while playing
